        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    adress_state = table.Column<string>(type: "text", nullable: false),
                    adress_street = table.Column<string>(type: "text", nullable: false),
                    adress_zip_code = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("pk_role_permission", x => new { x.permissions_id, x.role_id });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    cleaing_fee_amount = table.Column<decimal>(type: "numeric", nullable: false),
                    cleaing_fee_currency = table.Column<string>(type: "text", nullable: false),
                    ...
                    create_on_utc = table.Column<DateTime>(type: "timestamp with time zone", nullable: false),
