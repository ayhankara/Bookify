...
internal sealed class GetAllBookingsQueryHandler : IQueryHandler<GetAllBookingsQuery, BookingResponse>
{
    ...
    public async Task<BookingResponse> Handle(GetAllBookingsQuery request, CancellationToken cancellationToken)
    {
        ...
        return booking ?? throw new KeyNotFoundException($"Booking with ID {request.BookingId} not found.");
